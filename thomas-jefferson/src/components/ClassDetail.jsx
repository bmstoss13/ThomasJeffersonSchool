  ...
  return (
    <div>
      ...
      <Box sx={{ maxWidth: '1200px', mx: 'auto', overflowX: 'hidden' }}>
        ...
        <Typography variant="h3" fontFamily='Segoe UI' fontWeight="bold" color="#095256">{teacherInfo ? `${teacherInfo.first_name} ${teacherInfo.last_name}` : 'N/A'}’s Class</Typography>
        <Typography variant="subtitle1" color="black" gutterBottom>Overview of {teacherInfo ? `${teacherInfo.first_name} ${teacherInfo.last_name}` : 'N/A'}’s Class</Typography>
